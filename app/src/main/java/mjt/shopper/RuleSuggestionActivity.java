...
/**
 * RuleSuggestionActivity - Suggest rules based upon Shopping History
 *
 * When a product is BROUGHT from the shopping list the the productusage is
 * updated; the buycount is incremented and the latestbuydate is set to the
 * current date/time.
 * Thus over time the frequency that a single item is purchased can be
 * determined.
 * Thus a suggestion can be made for a rule to be made.
 * This activity displays a list allowing the rule to be added.
 * Additionally a rule can be skipped (temporarily ignored) or
 * disabled (flag to not appear in the suggestion list again).
 *
 * Note! the list is generated by invoking the getSuggestedRules method.
 */
...
public class RuleSuggestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        csr = db.getSuggestedRules(false,true,ShopperDBHelper.RULESUGGESTFLAG_ONLYCLEAR);
